...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white h-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="flex md:hidden">
            ...
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="inline-flex items-center justify-center p-2 focus:outline-none z-50">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-40 overflow-y-auto">
          <div className="fixed inset-0 bg-[#E1E8EF] bg-opacity-75" aria-hidden="true" onClick={() => setIsMenuOpen(false)}></div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 max-w-xs w-full">
              <div className="flex flex-col items-start">
                <nav className="space-y-4 text-start w-full">
                  <a href="#" className="block px-3 py-1 rounded-md text-base font-medium text-black">
                    Features
                  </a>
                  <a href="#" className="block px-3 py-1 rounded-md text-base font-medium text-black">
                    Testimonials
                  ...
                  <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sign in
                  </a>
                </nav>
              </div>
